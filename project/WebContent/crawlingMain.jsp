...
<body>
	<div class="wrapper">
		...
		<div class="temperature entypo-light-up">
			<h2>
				<span class="degree-symbol" id="tempShow">32℃</span>
				<ul id="simbol">
					<li class="fontawesome-leaf left" id="humShow"><span>4
							mph</span></li>
					<li class="fontawesome-tint center" id="rainShow"><span>65%</span></li>
